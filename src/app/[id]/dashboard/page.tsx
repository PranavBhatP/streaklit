...
const DashboardPage = ({ params }: { params: { id: string } }) => {
  ...
  if (!user) {
    return <div className ="flex h-screen items-center justify-center text-4xl font-bold">Loading...</div>;
  }
  ...
  return (
    <div className="flex">
      ...
      <div className="mt-1 flex gap-y-5 flex-col border-b py-6">
        ...
        <div className = "flex w-full border-b-4 items-center justify-center border-red-400 shadow-2xl rounded-xl h-96 heatmap-container">
          <CalendarHeatmap
